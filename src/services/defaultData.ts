...
export const DEFAULT_THEME_CONFIG: ThemeConfig = {
  ...
  header: {
    ...
    circleFieldMouse: 0.55,

    // Responsive header
    responsiveEnabled: true,
    responsiveBreakpointPx: 768,
    mobileHeightPx: 104,
    mobileContainerPaddingPx: 16,
    mobileBrandFontSizePx: 18,
    mobileBrandWeight: 900,
    mobileBrandLetterSpacing: -0.03,
    mobileIconSizePx: 22,
    mobileNavFontSizePx: 10,
    mobileNavGapPx: 12,
    mobileBrandMaxWidthPx: 260,
    desktopNavGapPx: 24,
    desktopContainerPaddingPx: 32,
    desktopBrandMaxWidthPx: 560,
    mobileShowBrandIcon: true,
    mobileShowTagline: false,
    mobile3dScale: 0.72,
    mobile3dDepth: 34,
    mobile3dMouseStrength: 0.7,
    mobileAnimationEnabled: true,
    mobileBackgroundEnabled: true,
    mobileBackgroundOpacity: 0.85,
  },
