...
export const EditorialHome: React.FC<EditorialHomeProps> = ({
  ...
  const Hero = () => (
    <section
      className="editorial-panel editorial-panel--pink editorial-hero"
    ...
    >
      ...
      <div className="editorial-hero-copy">
        ...
        <div className="editorial-star-doodle">
          <span
            className="editorial-star-mark editorial-star-mark--burst"
            aria-hidden="true"
          />
        </div>
      </div>
      ...
      <div
        className="editorial-hero-paper paper-one"
        aria-hidden="true"
      />

      <div
        className="editorial-hero-paper paper-two"
        aria-hidden="true"
      />
      ...
      <div className="editorial-hero-scribble">
        <span
          className="editorial-star-mark editorial-star-mark--diamond"
          aria-hidden="true"
        />
      </div>

      <div
        className="editorial-hero-star editorial-hero-star--one"
        aria-hidden="true"
      >
        <span
          className="editorial-star-mark editorial-star-mark--burst"
      ...
      <div
        className="editorial-hero-star editorial-hero-star--two"
        aria-hidden="true"
      >
        <span
          className="editorial-star-mark editorial-star-mark--diamond"
  ...
  const About = () => (
    <section
      className="editorial-panel editorial-panel--black editorial-about"
    ...
    >
      ...
      <div className="editorial-about-copy">
        <p>
          ...
          <br />
          <br />
          Sou estudante e tenho interesse por design de interfaces,
      ...
      <img
        src={settings.profile_image || photo('portana-about')}
  ...
  const Projects = () => (
    <section
      className="editorial-panel editorial-panel--pink editorial-projects"
      aria-label="Projetos"
    >
      <div className="editorial-index">02 / 05</div>

      <div
        className="editorial-page-star editorial-page-star--projects-one"
        aria-hidden="true"
      >
        <span
          className="editorial-star-mark editorial-star-mark--burst"
      ...
      <div
        className="editorial-page-star editorial-page-star--projects-two"
        aria-hidden="true"
      >
        <span
          className="editorial-star-mark editorial-star-mark--diamond"
        ...
        {[0, 1, 2, 3].map((i) => {
          ...
          return (
            <button
              ...
              onClick={() => p && onSelectProject(p.slug)}
            >
              <img
                src={imageFor(p, i)}
                alt={p?.title || fallbackTitles[i]}
              />

              <strong>
                {p?.title || fallbackTitles[i]}
              </strong>

              <span>
                {p?.description?.slice(0, 48) || fallbackSub[i]}
              </span>
  ...
  const Principles = () => (
    <section
      className="editorial-panel editorial-panel--black editorial-principles"
      aria-label="Princípios"
    >
      <div className="editorial-index">03 / 05</div>

      <div
        className="editorial-page-star editorial-page-star--principles"
        aria-hidden="true"
      >
        <span
          className="editorial-star-mark editorial-star-mark--burst"
      ...
      <div className="editorial-principles-body">
        ...
        <div className="editorial-quote-mark">
          <span
            className="editorial-star-mark editorial-star-mark--burst"
            aria-hidden="true"
          />
  ...
  const Contact = () => (
    <section
      className="editorial-panel editorial-panel--black editorial-contact"
      aria-label="Contato"
    >
      <div className="editorial-contact-title">
        VAMOS
        <br />
        CONVERSAR?
      </div>
      ...
      <div className="editorial-contact-links">
        ...
        {settings.social_links?.[0]?.url && (
          <a
            href={settings.social_links[0].url}
            target="_blank"
            rel="noreferrer"
          >
            <Instagram size={16} />
            {settings.social_links[0].platform}
          </a>
        )}
  ...
  const FooterCard = () => (
    <section
      className="editorial-panel editorial-panel--pink editorial-footer-card"
    ...
    >
      ...
      <div className="editorial-footer-star-doodle">
        <span
          className="editorial-star-mark editorial-star-mark--burst"
          aria-hidden="true"
        />
  ...
  // A navegação agora controla páginas independentes:
  // a Home mostra somente o portfólio,
  // Projetos mostra somente o acervo
  // e Sobre/Contato são páginas próprias.
  if (view === 'home') {
    return (
